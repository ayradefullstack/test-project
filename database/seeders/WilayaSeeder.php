...
class WilayaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $wilayas = [
            ...
            ['code' => '59', 'name_fr' => 'Aïn Oussara', 'name_ar' => 'عين وسارة'],
            ['code' => '60', 'name_fr' => 'Messaad', 'name_ar' => 'مسعد'],
            ['code' => '61', 'name_fr' => 'Bou Saâda', 'name_ar' => 'بوسعادة'],
            ['code' => '62', 'name_fr' => 'Barika', 'name_ar' => 'بريكة'],
            ['code' => '63', 'name_fr' => 'Ksar Chellala', 'name_ar' => 'قصر الشلالة'],
            ['code' => '64', 'name_fr' => 'Aflou', 'name_ar' => 'أفلو'],
            ['code' => '65', 'name_fr' => 'El Abiodh Sidi Cheikh', 'name_ar' => 'الأبيض سيدي الشيخ'],
            ['code' => '66', 'name_fr' => 'El Eulma', 'name_ar' => 'العلمة'],
            ['code' => '67', 'name_fr' => 'Sour El Ghozlane', 'name_ar' => 'سور الغزلان'],
            ['code' => '68', 'name_fr' => 'Akbou', 'name_ar' => 'أقبو'],
            ['code' => '69', 'name_fr' => 'Maghnia', 'name_ar' => 'مغنية'],
        ];
